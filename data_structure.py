...
print (str1[0:5])
print(str2[0:4]) #printing first five character using slice operator  
(str1[0:5])
...
A = {'name':["Sai","Yogesh","Pranav","Kailash","Shashi","Shreya","Sayali"],
    'Marks':[98,67,79,60,56,90,94],
    'City':['Pune','Mumbai','Chennai','Pune','Delhi','Aurangabad','Banglore'],
    'Subject':['Science','Maths','Chemistry','History','Maths','Geography','Science']}



A

df=pd.DataFrame(A,columns=['name','Marks','City','Subject'])
df

df.iloc[0:3]
df[['name','City','Subject']]
